...
namespace API.Controllers.Advertisements
{
    ...
    public class AdvertisementController : ControllerBase
    {
        ...
        public IActionResult GetAdvertisements(string cpf)
        {
            ...
            if (advertisements == null) return NotFound("Anúncios não encontrados");
        ...
        public IActionResult GetAdvertisementByCompany(string companyId)
        {
            ...
            if (advertisement == null) return NotFound("Anúncios não encontrados");
        ...
        public IActionResult GetAdvertisementById(string cpf)
        {
            ...
            if (advertisement == null) return NotFound("Anúncio não encontrado");
            else return Ok(advertisement);
        }
        ...
        public async Task<IActionResult> AddAdvertisement([FromBody] Advertisement advertisement)
        {
            ...
            if (_advertisement == null) return NotFound("Anúncio não encontrado");
        ...
        public async Task<IActionResult> DeleteAdvertisement([FromBody] Guid id)
        {
            ...
            if (_advertisement == false) return NotFound("Anúncio não encontrado");
            else return Ok(_advertisement);
        }
